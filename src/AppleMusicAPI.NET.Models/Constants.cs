...
namespace AppleMusicAPI.NET
{
    public static class Constants
    {
        public static class Resources
        {
            ...
            public const string AppleCurators = "appleCurators";
            public const string Artists = "artists";
            public const string Curators = "curators";
            public const string Genres = "genres";
            public const string LibraryAlbums = "libraryAlbums";
            public const string LibraryArtists = "libraryArtists";
